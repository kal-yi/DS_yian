...
from sklearn.metrics import confusion_matrix, accuracy_score, precision_score, recall_score, roc_auc_score, f1_score, log_loss
...
def fam_relationship(all_data2, fam_size, SibSp, Parch, fam_number, index_num):
    ...
    # 1 person
        ...
        if (SibSp == 0) & (Parch == 0):
            ...
            if (all_data2["Title"].loc[index_num] == "Mrs") & (all_data2["Age"].loc[index_num] <= 50):
    ...
    # 2 people
        ...
        list_fam_2 = []
        list_fam_2 = all_data2[all_data2["family_numbered"]==fam_number].index.tolist() # get the indexes of all family members

        if (all_data2["SibSp"].loc[list_fam_2[0]] == 1) & (all_data2["SibSp"].loc[list_fam_2[1]] == 1):
        ...
        elif (all_data2["Parch"].loc[list_fam_2[0]] == 1) & (all_data2["Parch"].loc[list_fam_2[1]] == 1):
            if all_data2["Age"].loc[list_fam_2[0]] > all_data2["Age"].loc[list_fam_2[1]]:
                if all_data2["Title"].loc[list_fam_2[0]] == "Mrs":
                    ...
                    return all_data2["fam_relationship"].loc[index_num] # mother or child
                else:
                    all_data2["fam_relationship"].loc[list_fam_2[0]] = "father"
                    all_data2["fam_relationship"].loc[list_fam_2[1]] = "child"
                    return all_data2["fam_relationship"].loc[index_num] # father or child
            else:
    ...
    # 3 people
        ...
        list_fam_3 = []
        list_fam_3 = all_data2[all_data2["family_numbered"]==fam_number].index.tolist() # get the indexes of all family members

        if (all_data2["SibSp"].loc[index_num] == 0) & (all_data2["Parch"].loc[index_num] == 2):
            list_fam_3.remove(index_num)
            if ((all_data2["Age"].loc[index_num]+float(12)) <= all_data2["Age"].loc[list_fam_3[0]]) & ((all_data2["Age"].loc[index_num]+float(12)) <= all_data2["Age"].loc[list_fam_3[1]]):
                all_data2["fam_relationship"].loc[index_num] = "child"
                ...
                all_data2["fam_relationship"].loc[index_num] = "child"
                return all_data2["fam_relationship"].loc[index_num] # not 100% accurate (it could be spend more time on it)
            else:
        ...
        elif (all_data2["SibSp"].loc[index_num] == 1) & (all_data2["Parch"].loc[index_num] == 1):
    ...
    # 4 people
        ...
        list_fam_4 = []
        list_fam_4 = all_data2[all_data2["family_numbered"]==fam_number].index.tolist() # get the indexes of all family members

        if (all_data2["SibSp"].loc[index_num] == 3) & (all_data2["Parch"].loc[index_num] == 0):
            all_data2["fam_relationship"].loc[index_num]= "husband or sibling"
            return all_data2["fam_relationship"].loc[index_num] # sibling

        elif (all_data2["SibSp"].loc[index_num] == 2) & (all_data2["Parch"].loc[index_num] == 1):
            all_data2["fam_relationship"].loc[index_num] = "child"
            return all_data2["fam_relationship"].loc[index_num]

        elif (all_data2["SibSp"].loc[index_num] == 0) & (all_data2["Parch"].loc[index_num] == 3):
            if (all_data2["Title"].loc[index_num] == "Mrs") or (all_data2["Title"].loc[index_num] == "Ms"):
                all_data2["fam_relationship"].loc[index_num] = "mother"
                return all_data2["fam_relationship"].loc[index_num]
            else:
                all_data2["fam_relationship"].loc[index_num] = "father"
        ...
        elif (all_data2["Title"].loc[index_num] == "Mrs") & (all_data2["Age"].loc[index_num] <= 50):
            all_data2["fam_relationship"].loc[index_num] = "mother"
            return all_data2["fam_relationship"].loc[index_num]
    ...
    # 5 people
        ...
        if (all_data2["SibSp"].loc[index_num] == 3) & (all_data2["Parch"].loc[index_num] == 1):
            all_data2["fam_relationship"].loc[index_num] = "child"
            return all_data2["fam_relationship"].loc[index_num]

        elif (all_data2["SibSp"].loc[index_num] == 2) & (all_data2["Parch"].loc[index_num] == 2):
            all_data2["fam_relationship"].loc[index_num] = "child"
            return all_data2["fam_relationship"].loc[index_num]

        elif ((all_data2["SibSp"].loc[index_num] == 1) & (all_data2["Parch"].loc[index_num] == 3)) or ((all_data2["SibSp"].loc[index_num] == 0) & (all_data2["Parch"].loc[index_num] == 4)):
            if ((all_data2["Title"].loc[index_num] == "Mrs") or (all_data2["Title"].loc[index_num] == "Ms")) & (all_data2["Age"].loc[index_num] <= 50):
                all_data2["fam_relationship"].loc[index_num] = "mother"
                return all_data2["fam_relationship"].loc[index_num]
            else:
                all_data2["fam_relationship"].loc[index_num]="husband or sibling"
    ...
    # 6 people
        ...
        if ((all_data2["SibSp"].loc[index_num] == 1) & (all_data2["Parch"].loc[index_num] == 4)) or ((all_data2["SibSp"].loc[index_num] == 0) & (all_data2["Parch"].loc[index_num] == 5)):
            if ((all_data2["Title"].loc[index_num] == "Mrs") or (all_data2["Title"].loc[index_num] == "Ms")) & (all_data2["Age"].loc[index_num] <= 50):
                all_data2["fam_relationship"].loc[index_num] = "mother"
                return all_data2["fam_relationship"].loc[index_num]
            else:
    ...
    # 7 people
        ...
        if ((all_data2["SibSp"].loc[index_num] == 1) & (all_data2["Parch"].loc[index_num] == 5)) or ((all_data2["SibSp"].loc[index_num] == 0) & (all_data2["Parch"].loc[index_num] == 6)):
            if ((all_data2["Title"].loc[index_num] == "Mrs") or (all_data2["Title"].loc[index_num] == "Ms")) & (all_data2["Age"].loc[index_num] <= 50):
                all_data2["fam_relationship"].loc[index_num] = "mother"
                return all_data2["fam_relationship"].loc[index_num]
            else:
    ...
    # 8 people
        ...
        if ((all_data2["SibSp"].loc[index_num] == 1) & (all_data2["Parch"].loc[index_num] == 6)) or ((all_data2["SibSp"].loc[index_num] == 0) & (all_data2["Parch"].loc[index_num] == 7)):
            if ((all_data2["Title"].loc[index_num] == "Mrs") or (all_data2["Title"].loc[index_num] == "Ms")) & (all_data2["Age"].loc[index_num] <= 50):
                all_data2["fam_relationship"].loc[index_num] = "mother"
                return all_data2["fam_relationship"].loc[index_num]
            else:
...
def data_preprocessing(X, X_test):
    ...
    for dataframe in [X, X_test]:
        list_a = list(dataframe[dataframe["Age"].astype(str).str.contains("\.5$")].index.values.tolist()) # list with indexes of people with approx age
        dataframe.loc[list_a, "Age"] = 80
    ...
    all_data["Title"] = splitted2.str[0]

    all_data["Title"] = all_data["Title"].replace([" Mr", " Miss", " Ms"," Mrs", " Master", " Dona", " Don", " Rev", " Dr", " Mme", " Major", " Lady", " Sir", " Mlle", " Col", " Capt", " the Countess", " Jonkheer"],
                                                  ["Mr", "Ms", "Ms", "Mrs", "Master", "Ms", "Mr", "Mr", "Dr", "Ms", "Mr", "Mrs", "Mr", "Ms", "Mr", "Mr", "Mrs", "Mr"])

    all_data["family_numbered"]=all_data.groupby(["Surname","Ticket"]).ngroup()
    all_data["Family_size"]=all_data.family_numbered.map(all_data.groupby("family_numbered").size()) # family size calculated
    all_data["Family_size2"]= all_data["SibSp"]+all_data["Parch"]+1 # true family size
    ...
    all_data2["fam_relationship"] = all_data2.apply(lambda column : fam_relationship(all_data2, column["Family_size"], column["SibSp"], column["Parch"],
                                                                                    column["family_numbered"], column.name), axis = 1)
    ...
    all_data2 = all_data2.drop(["Name", "1st name", "Surname", "Ticket", "family_numbered", "Family_size2","SibSp","Parch"], axis=1)
...
def hyperparams_selection(X, y):
    ...
    grid_params = {"n_estimators": range(340, 341, 5),
...
def create_X_test_pred(X, X_test, y, RF_hyperparams):

    best_parameters = RF_hyperparams

    RF_model = RandomForestClassifier(n_estimators=best_parameters["n_estimators"]
...
def Titanic_RF():
    ...
    pred_file = create_X_test_pred(X, X_test, y, RF_hyperparams)
